	...
	<view>
		...
		<view v-if="showHeader" class="header" :style="{ position: headerPosition,top:headerTop,opacity: afterHeaderOpacity }">
			...
			<view class="input-box">
				...
				<input placeholder="输入搜索内容" placeholder-style="color:#c0c0c0;" @tap="toSearch()" />
		...
		<view class="promotion">
			...
			<view class="list">
				...
				<view class="column" style="background-color: #FFFFFF;height: 240rpx;display: block; text-align: center; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.11);">
					<navigator open-type="navigate" url="/pages/start/start" hover-class="none">
						<image src="../../../static/img/icon/faqi.png" style="width: 120rpx; height: 120rpx;"></image>
						<view class="wenyue-font">发起团购</view>
						<view style="font-size: 28rpx; color: #999999;">优惠由你定义</view>
					</navigator>
				</view>
			</view>
		</view>
		...
		data() {
			return {
				...
				swiperList: [{
						id: 1,
						src: 'url1',
						img: 'http://localhost/photo/1.jpg'
					},
					{
						id: 2,
						src: 'url2',
						img: 'http://localhost/photo/2.jpg'
					},
					{
						id: 3,
						src: 'url3',
						img: 'http://localhost/photo/3.jpg'
					},
					{
						id: 4,
						src: 'url4',
						img: 'http://localhost/photo/4.jpg'
					},
					{
						id: 5,
						src: 'url5',
						img: 'http://localhost/photo/5.jpg'
					},
					{
						id: 6,
						src: 'url6',
						img: 'http://localhost/photo/6.jpg'
					},
					{
						id: 7,
						src: 'url7',
						img: 'http://localhost/photo/7.jpg'
					}
				],
